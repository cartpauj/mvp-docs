...
final readonly class Type
{
	...
	): self|string
	{
		if ($type instanceof \ReflectionNamedType) {
			...
			throw new \MvpDocs\Vendor\Nette\InvalidStateException('Unexpected type of ' . Reflection::toString($of));
		}
	}
	...
	public static function fromString(string $type): self
	{
		if (!Validators::isTypeDeclaration($type)) {
			throw new \MvpDocs\Vendor\Nette\InvalidArgumentException("Invalid type '$type'.");
		}
