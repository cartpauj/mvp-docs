...
trait Base
{
	...
	public function assert(callable $handler, ?string $description = null): self
	{
		...
		return $this->transform(function ($value, Context $context) use ($handler, $description, $expected) {
			...
			$context->addError(
				...
				MvpDocs\Vendor\Nette\Schema\Message::FailedAssertion,
	...
	private function doDeprecation(Context $context): void
	{
		if ($this->deprecated !== null) {
			$context->addWarning(
				$this->deprecated,
				MvpDocs\Vendor\Nette\Schema\Message::Deprecated,
			);
		}
	}
	...
	/** @deprecated use MvpDocs\Vendor\Nette\Schema\Validators::validateType() */
	...
	/**
	 * @deprecated use MvpDocs\Vendor\Nette\Schema\Validators::validateRange()
