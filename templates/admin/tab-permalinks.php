...
$mvpd_slug_errors = get_transient( 'mvpd_slug_errors' );
if ( $mvpd_slug_errors ) {
...
<form method="post" action="options.php">
	...
	foreach ( $s as $mvpd_key => $mvpd_val ) {
		if ( 'docs_slug' === $mvpd_key || 'category_slug' === $mvpd_key ) {
			continue;
		}
		printf(
	...
	<table class="form-table">
		<tr>
			...
			<td>
				...
				<input type="text" name="mvpd_settings[docs_slug]" id="mvpd-docs-slug" value="<?php echo esc_attr( $s['docs_slug'] ); ?>" class="regular-text<?php echo isset( $mvpd_slug_errors['docs_slug'] ) ? ' mvpd-field-error' : ''; ?>" />
				<code>/</code>
				...
				<?php if ( isset( $mvpd_slug_errors['docs_slug'] ) ) : ?>
					<p class="mvpd-inline-error"><?php echo esc_html( $mvpd_slug_errors['docs_slug'] ); ?></p>
				<?php else : ?>
		...
		<tr>
			...
			<td>
				<code><?php echo esc_html( home_url( '/' ) ); ?></code>
				<input type="text" name="mvpd_settings[category_slug]" id="mvpd-cat-slug" value="<?php echo esc_attr( $s['category_slug'] ); ?>" class="regular-text<?php echo isset( $mvpd_slug_errors['category_slug'] ) ? ' mvpd-field-error' : ''; ?>" />
				<code>/</code>
				...
				<?php if ( isset( $mvpd_slug_errors['category_slug'] ) ) : ?>
					<p class="mvpd-inline-error"><?php echo esc_html( $mvpd_slug_errors['category_slug'] ); ?></p>
				<?php else : ?>
